...
| -------------------------- | ------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| WebUSB                     | Chrome / Edge desktop browsers             | [Step 3 · Initialise the SDK](broken-reference)              | [hardware-js-sdk/packages/connect-examples](https://github.com/OneKeyHQ/hardware-js-sdk/tree/develop/packages/connect-examples) | [Common Connect guide](transport-recipes/common-connect.md)                                    | Requires a user gesture; Windows needs WinUSB drivers                                                                            |
| WebBLE                     | Chromium browsers with Web Bluetooth       | [Next steps](broken-reference) → WebBLE                      | [hardware-js-sdk/packages/connect-examples](https://github.com/OneKeyHQ/hardware-js-sdk/tree/develop/packages/connect-examples) | [Common Connect guide](transport-recipes/common-connect.md)                                    | First pairing prompts Bluetooth authorisation dialogs                                                                            |
...
| Native shells (USB)        | Electron, Flutter, native desktop shells   | [Next steps](broken-reference) → native shells               | [hardware-js-sdk/packages/connect-examples](https://github.com/OneKeyHQ/hardware-js-sdk/tree/develop/packages/connect-examples) | [Common SDK guide](explanations/hardware-sdk/common-sdk-guide.md)                              | Inject a low-level transport adapter and manage lifecycle threads                                                                |
| Custom low-level transport | Gateways, embedded hosts, bespoke runtimes | [Next steps](broken-reference) → custom transports           | [hardware-js-sdk/packages/connect-examples](https://github.com/OneKeyHQ/hardware-js-sdk/tree/develop/packages/connect-examples) | [Low-level transport plugin](transport-recipes/common-connect-1/low-level-transport-plugin.md) | Follow the [OneKey Message Protocol](transport-recipes/common-connect-1/onekey-message-protocol.md) and enforce timeouts/retries |
